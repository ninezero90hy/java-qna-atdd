...
public class AnswerTest {
  ...
  public void 답변_등록() {
    ...
    final User write = createUser("ninezero90hy", "ninezero90hy@", "ninezero",
  ...
  public void 질문한_사람과_로그인한_사람이_같지만_답변의_글쓴이가_다른_경우_삭제_가능하지_않음() {
    ...
    final User loginUser = createUser("ninezero90hy", "ninezero90hy@", "ninezero",
        "ninezero90hy@gmail.com");
    ...
    question
        .writeBy(createUser("ninezero90hy", "ninezero90hy@", "ninezero", "ninezero90hy@gmail.com"));
    question.addAnswer(answer);
