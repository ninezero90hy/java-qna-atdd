...
public class ApiUserAcceptanceTest extends AcceptanceTest {
  ...
  public void 사용자_생성() {
    ...
    final User dbUser = basicAuthTemplate(findByUserId(newUser.getUserId()))
  ...
  public void 로그인한_상태에서_자신의_정보_수정() {
    ...
    final User updateUser = new User(original.getId(), original.getUserId(), original.getPassword(),
  ...
  public void 다른_사람_정보_수정() {
    ...
    final User updateUser = new User(newUser.getUserId(), newUser.getPassword(), "name2",
        "javajigi@slipp.net2");
