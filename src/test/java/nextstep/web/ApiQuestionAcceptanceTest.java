...
public class ApiQuestionAcceptanceTest extends AcceptanceTest {
  ...
  public void 로그인한_상태에서_질문_생성() {
    ...
    final ResponseEntity<Question> dbQuestion = basicAuthTemplate()
        .getForEntity(location, Question.class);
  ...
  public void 로그인_상태에서_내가_작성한_글_삭제() {
    ...
    final ResponseEntity<String> responseQuestion
        = basicAuthTemplate()
        .exchange(format("/api/questions/%d", savedQuestion.getId()), HttpMethod.DELETE, null,
            String.class);
